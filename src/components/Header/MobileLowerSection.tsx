    ...
    <div className="px-5 py-6 space-y-6">
      <div className="grid grid-cols-2 gap-x-8 gap-y-4">
        {additionalMobileMenuLinks.map(({ link, i18nKey, disabled }) => (
          <Link
            className="text-neutral hover:text-base-300 aria-disabled:pointer-events-none aria-disabled:opacity-50"
            href={link}
            key={i18nKey}
      ...
      <Link
        href="#"
        className="btn w-full text-white bg-indigo-500 hover:bg-indigo-600 aria-disabled:pointer-events-none aria-disabled:opacity-50"
        aria-disabled={true}
      >
        {t('signUp')}
      </Link>
